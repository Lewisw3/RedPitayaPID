...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.240 . Memory (MB): peak = 787.547 ; gain = 0.0002default:default


Phase %s%s
101*constraints2
...
T
HPhase 1.2 Build Super Logic Region (SLR) Database | Checksum: 14877c75a
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.250 . Memory (MB): peak = 787.547 ; gain = 0.0002default:default
i

Phase %s%s
101*constraints2
...
<
0Phase 1.3 Add Constraints | Checksum: 14877c75a
*common
‰

%s
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.850 . Memory (MB): peak = 787.547 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.860 . Memory (MB): peak = 787.547 ; gain = 0.0002default:default
z

Phase %s%s
101*constraints2
...
M
APhase 1.6 Implementation Feasibility check | Checksum: 1756cabec
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 787.547 ; gain = 0.0002default:default
i

Phase %s%s
101*constraints2
...
<
0Phase 1.7 Pre-Place Cells | Checksum: 1756cabec
*common
…

%s
...
_
SPhase 1.8 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1756cabec
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 787.566 ; gain = 0.0202default:default
t

Phase %s%s
101*constraints2
...
@
4Phase 1.9.1.1 Build Clock Data | Checksum: c7d26529
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:04 ; elapsed = 00:00:04 . Memory (MB): peak = 804.551 ; gain = 17.0042default:default
@
4Phase 1.9.1 Place Init Design | Checksum: 13868b048
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 804.551 ; gain = 17.0042default:default
G
...
P
DPhase 1.10.1 Constrain Global/Regional Clocks | Checksum: 129bd0f66
*common
†

%s
...
[Time (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 804.551 ; gain = 17.0042default:default
E
9Phase 1.10 Constrain Clocks/Macros | Checksum: 129bd0f66
*common
†

%s
...
[Time (s): cpu = 00:00:05 ; elapsed = 00:00:04 . Memory (MB): peak = 804.551 ; gain = 17.0042default:default
@
4Phase 1 Placer Initialization | Checksum: 129bd0f66
*common
†

%s
...
%s
*constraints2o
[Time (s): cpu = 00:00:25 ; elapsed = 00:00:20 . Memory (MB): peak = 806.434 ; gain = 18.8872default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:00:28 ; elapsed = 00:00:22 . Memory (MB): peak = 811.273 ; gain = 23.7272default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 14d4f972a
*common
†

%s
...
A
5Phase 3.4 Timing Path Optimizer | Checksum: f792e17d
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:29 ; elapsed = 00:00:22 . Memory (MB): peak = 812.328 ; gain = 24.7812default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 183d8a98e
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:31 ; elapsed = 00:00:25 . Memory (MB): peak = 817.023 ; gain = 29.4772default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 183d8a98e
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:32 ; elapsed = 00:00:25 . Memory (MB): peak = 817.098 ; gain = 29.5512default:default
;
...
D
8Phase 4.1.1 Restore Best Placement | Checksum: 7361b952
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:19 ; elapsed = 00:01:13 . Memory (MB): peak = 820.094 ; gain = 32.5472default:default
N
BPhase 4.1 Post Placement Timing Optimization | Checksum: 7361b952
*common
†

%s
...
B
6Phase 4.2 Post Placement Cleanup | Checksum: 7361b952
*common
†

%s
...
B
6Phase 4.3.1 Congestion Reporting | Checksum: 7361b952
*common
†

%s
...
B
6Phase 4.3.2 Dump Critical Paths  | Checksum: 7361b952
*common
†

%s
...
=
1Phase 4.3.4 Print Final WNS | Checksum: 7361b952
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:22 ; elapsed = 00:01:14 . Memory (MB): peak = 828.234 ; gain = 40.6882default:default
=
1Phase 4.3 Placer Reporting | Checksum: 1584d158a
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:22 ; elapsed = 00:01:14 . Memory (MB): peak = 828.566 ; gain = 41.0202default:default
q

Phase %s%s
101*constraints2
...
D
8Phase 4.4 Final Placement Cleanup | Checksum: 1bd12bfe2
*common
†

%s
...
[Time (s): cpu = 00:01:22 ; elapsed = 00:01:14 . Memory (MB): peak = 828.566 ; gain = 41.0202default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 1bd12bfe2
*common
†

%s
...
%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:01:14 . Memory (MB): peak = 828.566 ; gain = 41.0202default:default
Q
Releasing license: %s
83*common2"
...
828.5662default:default2
43.1522default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.090 . Memory (MB): peak = 831.617 ; gain = 0.000
*common
j
